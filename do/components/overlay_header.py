...
class OverlayHeaderTitleLabel(QLabel):
    def __init__(self, title, parent=None):
        ...
        self.setObjectName('OverlayHeaderTitleLabel')
        self.setStyleSheet(load_qss_for(self.__class__.__name__))
...
class OverlayHeaderSizeGrip(QSizeGrip):
    def __init__(self, parent):
        super().__init__(parent)
        self.setObjectName('OverlayHeaderSizeGrip')
        self.setStyleSheet(load_qss_for(self.__class__.__name__))
...
class OverlayHeaderToggleButton(QToolButton):
    def __init__(self, parent):
        ...
        self.setObjectName('OverlayHeaderToggleButton')
        self.setStyleSheet(load_qss_for('OverlayHeaderToggleButton'))
